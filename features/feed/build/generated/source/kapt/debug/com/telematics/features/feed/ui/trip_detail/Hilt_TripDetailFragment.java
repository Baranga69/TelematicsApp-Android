 ...
 */
public abstract class Hilt_TripDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TripDetailFragment_GeneratedInjector) this.generatedComponent()).injectTripDetailFragment(UnsafeCasts.<TripDetailFragment>unsafeCast(this));
    }
  }
