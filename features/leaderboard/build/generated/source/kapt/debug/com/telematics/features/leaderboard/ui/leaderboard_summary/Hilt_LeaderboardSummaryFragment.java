...
public abstract class Hilt_LeaderboardSummaryFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeaderboardSummaryFragment_GeneratedInjector) this.generatedComponent()).injectLeaderboardSummaryFragment(UnsafeCasts.<LeaderboardSummaryFragment>unsafeCast(this));
    }
  }
