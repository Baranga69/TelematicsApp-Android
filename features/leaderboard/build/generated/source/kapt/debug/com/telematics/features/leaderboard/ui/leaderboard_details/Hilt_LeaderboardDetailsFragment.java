...
public abstract class Hilt_LeaderboardDetailsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeaderboardDetailsFragment_GeneratedInjector) this.generatedComponent()).injectLeaderboardDetailsFragment(UnsafeCasts.<LeaderboardDetailsFragment>unsafeCast(this));
    }
  }
