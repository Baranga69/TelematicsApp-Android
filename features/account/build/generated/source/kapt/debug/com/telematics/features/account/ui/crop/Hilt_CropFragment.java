...
public abstract class Hilt_CropFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CropFragment_GeneratedInjector) this.generatedComponent()).injectCropFragment(UnsafeCasts.<CropFragment>unsafeCast(this));
    }
  }
