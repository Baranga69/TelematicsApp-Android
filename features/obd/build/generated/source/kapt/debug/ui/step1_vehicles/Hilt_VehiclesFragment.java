 ...
 */
public abstract class Hilt_VehiclesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VehiclesFragment_GeneratedInjector) this.generatedComponent()).injectVehiclesFragment(UnsafeCasts.<VehiclesFragment>unsafeCast(this));
    }
  }
