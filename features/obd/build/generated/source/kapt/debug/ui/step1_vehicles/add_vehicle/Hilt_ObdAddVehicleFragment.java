 ...
 */
public abstract class Hilt_ObdAddVehicleFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ObdAddVehicleFragment_GeneratedInjector) this.generatedComponent()).injectObdAddVehicleFragment(UnsafeCasts.<ObdAddVehicleFragment>unsafeCast(this));
    }
  }
