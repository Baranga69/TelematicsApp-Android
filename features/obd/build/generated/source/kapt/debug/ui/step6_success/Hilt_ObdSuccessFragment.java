 ...
 */
public abstract class Hilt_ObdSuccessFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ObdSuccessFragment_GeneratedInjector) this.generatedComponent()).injectObdSuccessFragment(UnsafeCasts.<ObdSuccessFragment>unsafeCast(this));
    }
  }
