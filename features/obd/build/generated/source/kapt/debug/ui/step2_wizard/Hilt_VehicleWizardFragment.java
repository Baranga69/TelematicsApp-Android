 ...
 */
public abstract class Hilt_VehicleWizardFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VehicleWizardFragment_GeneratedInjector) this.generatedComponent()).injectVehicleWizardFragment(UnsafeCasts.<VehicleWizardFragment>unsafeCast(this));
    }
  }
