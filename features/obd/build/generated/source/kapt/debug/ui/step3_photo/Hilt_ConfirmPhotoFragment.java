...
public abstract class Hilt_ConfirmPhotoFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConfirmPhotoFragment_GeneratedInjector) this.generatedComponent()).injectConfirmPhotoFragment(UnsafeCasts.<ConfirmPhotoFragment>unsafeCast(this));
    }
  }
