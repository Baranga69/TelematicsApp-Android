 ...
 */
public abstract class Hilt_FoundedDevicesFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FoundedDevicesFragment_GeneratedInjector) this.generatedComponent()).injectFoundedDevicesFragment(UnsafeCasts.<FoundedDevicesFragment>unsafeCast(this));
    }
  }
