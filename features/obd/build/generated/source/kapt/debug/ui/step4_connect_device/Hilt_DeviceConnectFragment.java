 ...
 */
public abstract class Hilt_DeviceConnectFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeviceConnectFragment_GeneratedInjector) this.generatedComponent()).injectDeviceConnectFragment(UnsafeCasts.<DeviceConnectFragment>unsafeCast(this));
    }
  }
