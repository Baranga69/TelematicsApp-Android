...
public abstract class Hilt_StreaksFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StreaksFragment_GeneratedInjector) this.generatedComponent()).injectStreaksFragment(UnsafeCasts.<StreaksFragment>unsafeCast(this));
    }
  }
