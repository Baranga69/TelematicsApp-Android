...
public abstract class Hilt_DrivecoinsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DrivecoinsFragment_GeneratedInjector) this.generatedComponent()).injectDrivecoinsFragment(UnsafeCasts.<DrivecoinsFragment>unsafeCast(this));
    }
  }
