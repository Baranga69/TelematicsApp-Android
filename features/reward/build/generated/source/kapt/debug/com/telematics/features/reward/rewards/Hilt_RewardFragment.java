...
public abstract class Hilt_RewardFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RewardFragment_GeneratedInjector) this.generatedComponent()).injectRewardFragment(UnsafeCasts.<RewardFragment>unsafeCast(this));
    }
  }
